...
typedef enum
{
    ...
    STACK_FAULT_VALIDATE_DET,
    STACK_FAULT_LFO,
    STACK_FAULT_SHUTDOWN_REC,
    STACK_FAULT_DRST,
    STACK_FAULT_CTL,
    STACK_FAULT_CTS,
    STACK_FAULT_TSHUT,
    STACK_FAULT_INH,
    STACK_FAULT_CVDD_UV_DRST,
    STACK_FAULT_CVDD_OV,
    STACK_FAULT_DVDD_OV,
    STACK_FAULT_AVDDREF_OV,
    STACK_FAULT_FCOMM_DET,
    STACK_FAULT_FTONE_DET,
    STACK_FAULT_HB_FAIL,
    STACK_FAULT_HB_FAST,
    STACK_FAULT_UART_FRAME,
    STACK_FAULT_COMMCRL_DET,
    STACK_FAULT_STOP_DET,
    STACK_FAULT_AVAO_SW_FAIL,
    STACK_FAULT_SPI_FRAME,
    STACK_FAULT_SPI_PHY,
    STACK_FAULT_COML_FRAME,
