...
#define EEPROM_BLACKBOX_BASE_ADDR       (2 * EEPROM_PAGE_SIZE)
#define EEPROM_BLACKBOX_PAGES           5   // 5 pages for 10 snapshots (~1280 bytes)
#define EEPROM_BLACKBOX_META_ADDR       (EEPROM_BLACKBOX_BASE_ADDR + (EEPROM_BLACKBOX_PAGES * EEPROM_PAGE_SIZE))
