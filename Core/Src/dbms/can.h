...
#define CANID_RX_OBJSTORE_SAVE      0x530 // 53 = AWS S3
#define CANID_TX_OBJSTORE_ACK       0x531
#define CANID_RX_OBJSTORE_REQUEST   0x532
#define CANID_TX_OBJSTORE_SEND      0x533
